<template>
    <div class="box">
        <div class="oprate-box">
            <div class="title">操作<span class="sector">好春盘点后台系统</span></div>
            <div>
       ...
       <div class="check-box">
            ...
            <el-row :gutter="24">
                <el-col :span="6" style="margin-top: 3px;">SKU号<el-input v-model="inputData[0].sku" placeholder="请输入SKU号"></el-input></el-col>
                <el-col :span="6" style="margin-top: 3px;">库位号<el-input v-model="inputData[0].stock" placeholder="请输入库位号"></el-input></el-col>
                <el-col :span="6" style="margin-top: 3px;">预更改名称<el-input v-model="inputData[0].preName" placeholder="请输入预更改的名称"></el-input></el-col>
                <el-col :span="6" style="margin-top: 3px;">预更改数量<el-input v-model="inputData[0].preNumber" placeholder="请输入预更改的数量"></el-input></el-col>
            </el-row>
        </div>
        <div class="table-box" >
            ...
            <div>
                <el-table border :data="tableData" @selection-change="SelectRow" max-height="650px"> 
                    ...
                    <el-table-column show-overflow-tooltip label="SKU号" width="160px" prop="sku" fixed/>
                    <el-table-column show-overflow-tooltip label="商品名称" width="326px" prop="shop_name"/>
                    <el-table-column show-overflow-tooltip label="商品规格" width="255px" prop="shop_style"/>
                    <el-table-column show-overflow-tooltip label="库位号" width="190px" prop="stock"/>
                    <el-table-column show-overflow-tooltip label="操作员" width="90px" prop="operator"/>
                    <el-table-column show-overflow-tooltip label="数量" width="80px" prop="numbers"/>
                    <el-table-column show-overflow-tooltip label="备注" width="150px" prop="remark"/>
                    <el-table-column show-overflow-tooltip label="记录时间" width="190px" prop="dateTime"/>
...
<script setup>
    ...
    const getStorageList = () => {//查询
        ...
        axios.post('http://134.175.18.3:8083/api/HC/InventoryCheck',inputData.value[0],{
    ...
    const nextStep = () =>{//导出
        ...
        const date = new Date();
        const fileName = `盘点异常数据_${date.getFullYear()}${String(date.getMonth() + 1).padStart(2, '0')}${String(date.getDate()).padStart(2, '0')}.xlsx`;
    ...
    const changeName = () =>{//改名
        ...
        axios.post('http://134.175.18.3:8083/api/HC/InventoryChangeName',{
    ...
    const changeNumber = () =>{//修改数量
        ...
        // console.log(selectedRow.value[0].logs_id)
        // console.log(inputData.value[0].preName)
        axios.post('http://134.175.18.3:8083/api/HC/InventoryChangeNumber',{
            logsId: selectedRow.value[0].logs_id, 
    ...
    const delStorage = () =>{
        ...
        console.log(selectedRow.value)
        axios.post('http://134.175.18.3:8083/api/HC/InventoryDelete',
            selectedRow.value
        ,{
            headers: {'Content-Type': 'application/json'},
        })
